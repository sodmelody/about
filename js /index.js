$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*Hello，我叫Lunatic，是一名准计算机专业的学生</div>");
	...
	w.load("<p><div class='writecode'>Lunatic</div>");
	w.load("<div class='writecode'>学生</div>");
	w.load("<div class='writecode'>伪ACMer / 咸鱼 / 宇宙第一帅</div></p>");
	//w.load("<div class='writecode'>关注微信公众号: 获取本人联系方式</div></p>");
	w.load("<h1 class='writecode'>联系</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Mail:<a href='2320874815@qq.com' target='_blank'>2320874815@qq.com</li>");
	w.load("<li class='writecode'>Blog:<a href='https://www.9527tech.com' target='_blank'>https://www.9527tech.com</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/9527tech' target='_blank'>https://github.com/9527tech</a></li>");
	w.load("</ul>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ:2320874815</div>");
	c.load("<div class='comment writecode'>&nbsp;*Mail:2320874815@qq.com</div>");
